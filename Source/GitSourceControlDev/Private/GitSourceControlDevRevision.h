...
class FGitSourceControlDevRevision : public ISourceControlRevision, public TSharedFromThis<FGitSourceControlDevRevision, ESPMode::ThreadSafe>
{
public:
	FGitSourceControlDevRevision()
		: RevisionNumber(0)
	{
	}
...
typedef TArray< TSharedRef<FGitSourceControlDevRevision, ESPMode::ThreadSafe> >	TGitSourceControlDevHistory;
