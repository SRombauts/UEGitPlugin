...
class IGitSourceControlDevWorker
{
public:
	/**
	 ...
	 */
	virtual bool Execute( class FGitSourceControlDevCommand& InCommand ) = 0;
...
typedef TSharedRef<IGitSourceControlDevWorker, ESPMode::ThreadSafe> FGitSourceControlDevWorkerRef;