 ...
 */
class FGitSourceControlDevCommand : public IQueuedWork
{
public:

	FGitSourceControlDevCommand(const TSharedRef<class ISourceControlOperation, ESPMode::ThreadSafe>& InOperation, const TSharedRef<class IGitSourceControlDevWorker, ESPMode::ThreadSafe>& InWorker, const FSourceControlOperationComplete& InOperationCompleteDelegate = FSourceControlOperationComplete() );
...
public:
	...
	TSharedRef<class IGitSourceControlDevWorker, ESPMode::ThreadSafe> Worker;
