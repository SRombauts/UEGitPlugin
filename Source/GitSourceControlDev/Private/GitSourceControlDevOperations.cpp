...
bool FGitConnectWorker::Execute(FGitSourceControlDevCommand& InCommand)
{
	check(InCommand.Operation->GetName() == GetName());

	InCommand.bCommandSuccessful = GitSourceControlDevUtils::RunCommand(TEXT("status"), InCommand.PathToGitBinary, InCommand.PathToRepositoryRoot, TArray<FString>(), TArray<FString>(), InCommand.InfoMessages, InCommand.ErrorMessages);
...
bool FGitCheckInWorker::Execute(FGitSourceControlDevCommand& InCommand)
{
	check(InCommand.Operation->GetName() == GetName());
	...
	if(CommitMsgFile.GetFilename().Len() > 0)
	{
		...
		InCommand.bCommandSuccessful = GitSourceControlDevUtils::RunCommit(InCommand.PathToGitBinary, InCommand.PathToRepositoryRoot, Parameters, InCommand.Files, InCommand.InfoMessages, InCommand.ErrorMessages);
	...
	GitSourceControlDevUtils::RunUpdateStatus(InCommand.PathToGitBinary, InCommand.PathToRepositoryRoot, InCommand.Files, InCommand.ErrorMessages, States);
...
{
	return GitSourceControlDevUtils::UpdateCachedStates(States);
}
...
bool FGitMarkForAddWorker::Execute(FGitSourceControlDevCommand& InCommand)
{
	check(InCommand.Operation->GetName() == GetName());

	InCommand.bCommandSuccessful = GitSourceControlDevUtils::RunCommand(TEXT("add"), InCommand.PathToGitBinary, InCommand.PathToRepositoryRoot, TArray<FString>(), InCommand.Files, InCommand.InfoMessages, InCommand.ErrorMessages);
...
bool FGitDeleteWorker::Execute(FGitSourceControlDevCommand& InCommand)
{
	check(InCommand.Operation->GetName() == GetName());

	InCommand.bCommandSuccessful = GitSourceControlDevUtils::RunCommand(TEXT("rm"), InCommand.PathToGitBinary, InCommand.PathToRepositoryRoot, TArray<FString>(), InCommand.Files, InCommand.InfoMessages, InCommand.ErrorMessages);
...
bool FGitRevertWorker::Execute(FGitSourceControlDevCommand& InCommand)
{
	// reset any changes already added in index
	{
		InCommand.bCommandSuccessful = GitSourceControlDevUtils::RunCommand(TEXT("reset"), InCommand.PathToGitBinary, InCommand.PathToRepositoryRoot, TArray<FString>(), InCommand.Files, InCommand.InfoMessages, InCommand.ErrorMessages);
	}

	// revert any changes in working copy
	{
		InCommand.bCommandSuccessful = GitSourceControlDevUtils::RunCommand(TEXT("checkout"), InCommand.PathToGitBinary, InCommand.PathToRepositoryRoot, TArray<FString>(), InCommand.Files, InCommand.InfoMessages, InCommand.ErrorMessages);
	}
...
bool FGitUpdateStatusWorker::Execute(FGitSourceControlDevCommand& InCommand)
{
	check(InCommand.Operation->GetName() == GetName());
	...
	{
		InCommand.bCommandSuccessful = GitSourceControlDevUtils::RunUpdateStatus(InCommand.PathToGitBinary, InCommand.PathToRepositoryRoot, InCommand.Files, InCommand.ErrorMessages, States);
		GitSourceControlDevUtils::RemoveRedundantErrors(InCommand, TEXT("' is outside repository"));
		...
		if(Operation->ShouldUpdateHistory())
		{
			for(int32 Index = 0; Index < States.Num(); Index++)
			{
				...
				if(States[Index].IsConflicted())
				{
					...
					GitSourceControlDevUtils::RunGetHistory(InCommand.PathToGitBinary, InCommand.PathToRepositoryRoot, File, true, InCommand.ErrorMessages, History);
				}
				// Get the history of the file in the current branch
				InCommand.bCommandSuccessful &= GitSourceControlDevUtils::RunGetHistory(InCommand.PathToGitBinary, InCommand.PathToRepositoryRoot, File, false, InCommand.ErrorMessages, History);
	...
	else
	{
		...
		if(Operation->ShouldGetOpenedOnly())
		{
			...
			InCommand.bCommandSuccessful = GitSourceControlDevUtils::RunUpdateStatus(InCommand.PathToGitBinary, InCommand.PathToRepositoryRoot, Files, InCommand.ErrorMessages, States);
		}
	}
...
{
	bool bUpdated = GitSourceControlDevUtils::UpdateCachedStates(States);
	...
	{
		TSharedRef<FGitSourceControlDevState, ESPMode::ThreadSafe> State = Provider.GetStateInternal(History.Key);
...
bool FGitCopyWorker::Execute(FGitSourceControlDevCommand& InCommand)
{
	check(InCommand.Operation->GetName() == GetName());
...
{
	return GitSourceControlDevUtils::UpdateCachedStates(OutStates);
}
...
bool FGitResolveWorker::Execute( class FGitSourceControlDevCommand& InCommand )
{
	check(InCommand.Operation->GetName() == GetName());
	...
	// mark the conflicting files as resolved:
	{
		...
		InCommand.bCommandSuccessful = GitSourceControlDevUtils::RunCommand(TEXT("add"), InCommand.PathToGitBinary, InCommand.PathToRepositoryRoot, TArray<FString>(), InCommand.Files, Results, InCommand.ErrorMessages);
	}
