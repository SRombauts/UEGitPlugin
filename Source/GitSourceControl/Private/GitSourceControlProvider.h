...
public:
	...
	virtual void RegisterStateBranches(const TArray<FString>& BranchNames, const FString& ContentRoot) /* UE4.20 override */ {}
	virtual int32 GetStateBranchIndex(const FString& InBranchName) const /* UE4.20 override */ { return INDEX_NONE; }
